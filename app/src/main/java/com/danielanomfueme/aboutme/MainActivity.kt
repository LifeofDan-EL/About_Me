package com.danielanomfueme.aboutme
...
import com.danielanomfueme.aboutme.databinding.ActivityMainBinding
import java.util.*
...
class MainActivity : AppCompatActivity() {
    ...
    private val myName: MyName = MyName("Daniel Anomfueme")

    override fun onCreate(savedInstanceState: Bundle?) {
            super.onCreate(savedInstanceState)
//            Setting the content view using DataBindingUtil creates an instance of
//            ActivityMainBinding from the supplied activity and the supplied layout.
//            This object contains mappings between the activity and layout,
